...
INSERT INTO USER (ID, USERNAME, PASSWORD, NICKNAME, GROUP_ID, EMAIL, MOBILE, GENDER, IS_TAB, THEME, AVATAR, DESCRIPTION, LAST_LOGIN_TIME, STATUS, DELETED, CREATE_TIME, MODIFY_TIME) VALUES (1, 'guqing', '$2a$10$QlnuHIZGb9u.Q04J2aJ5De29tV3/rBiwDS/LnRQeajsILnGA4xjfK', '聽見下雨的聲音', 1, 'example@example.com', '123555678345', 0, 0, null, 'https://violet-cloud.oss-cn-hangzhou.aliyuncs.com/8e80f601-4001-4d6f-846f-ca0938c76bf8', '毕生所求无它，爱与自由而已', '2020-10-15 16:17:16.000000', 0, 0, '2020-05-25 18:06:52.000000', '2020-05-25 18:06:52.000000');
